...
export default function UpdatesPage() {
 ...
 Stay informed about your tests, results, and campus activities.
 </p>
 </div>
 ...
 <TabsList>
 <TabsTrigger value="all" className="!outline-none !ring-0 !ring-offset-0 !focus-visible:ring-0 !focus-visible:ring-offset-0 !focus-visible:outline-none !focus-visible:border-transparent !shadow-none">
 All Updates
 <Badge variant="secondary" className="ml-2">{notifications.length}</Badge>
 </TabsTrigger>
 <TabsTrigger value="unread" className="!outline-none !ring-0 !ring-offset-0 !focus-visible:ring-0 !focus-visible:ring-offset-0 !focus-visible:outline-none !focus-visible:border-transparent !shadow-none">
 Unread
 {unreadNotifications.length > 0 && (
 <Badge variant="destructive" className="ml-2">{unreadNotifications.length}</Badge>
 )}
 </TabsTrigger>
 <TabsTrigger value="read" className="!outline-none !ring-0 !ring-offset-0 !focus-visible:ring-0 !focus-visible:ring-offset-0 !focus-visible:outline-none !focus-visible:border-transparent !shadow-none">Read</TabsTrigger>
 </TabsList>
