...
export function SignOutAnimationOverlay({ visible }: { visible: boolean }) {
  if (!visible) return null;

  return (
    <div className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-brown-950/80 backdrop-blur-md text-white animate-fade-in duration-300">
      <div className="flex flex-col items-center max-w-sm text-center px-8 py-8 rounded-2xl bg-brown-900/90 border border-amber-500/30 shadow-2xl shadow-black/50 space-y-6 animate-scale-up">
