...
const buttonVariants = cva(
 // base
 'inline-flex items-center justify-center gap-2 font-bold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/50 disabled:opacity-50 active:scale-[0.98]',
 {
 variants: {
 variant: {
