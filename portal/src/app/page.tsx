  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-brown-50 font-body text-foreground selection:bg-amber-500/20">
      ...
      <section
        id="hero"
        aria-label="Hero"
        className="relative flex min-h-screen items-center overflow-hidden bg-[linear-gradient(155deg,rgb(var(--color-primary-900))_0%,rgb(var(--color-primary-800))_52%,rgb(var(--color-primary-700))_100%)] px-4 pb-12 pt-24 sm:px-5 sm:pb-14 md:px-8 md:pb-16 lg:px-[clamp(28px,5vw,80px)] lg:pb-20 lg:pt-32 xl:px-[clamp(40px,6vw,80px)]"
      >
